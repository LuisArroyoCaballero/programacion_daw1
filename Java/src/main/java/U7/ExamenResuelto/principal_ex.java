...
public class principal_ex {
  public static void main(String[] args) {
    ...
    Medico m2 = new Medico("Alvaro", "Arcelado", 98546, "Juan Ramon Jimenez");
    Medico m3 = new Medico("Carmen", "Zamora", 788456, "Virgen del Rocio");

    Paciente p1 = new Paciente("Jorge", 56, 67, true, m1, Cepa.L);
    Paciente p2 = new Paciente("Alberto", 57, 45, true, m1, Cepa.M);
    Paciente p3 = new Paciente("Andres", 59, 66, true, m2, Cepa.N);
    Paciente p4 = new Paciente("Desiree", 54, 37, false, m2, Cepa.L);
    Paciente p5 = new Paciente("Maria", 23, 98, true, m2, Cepa.M);
